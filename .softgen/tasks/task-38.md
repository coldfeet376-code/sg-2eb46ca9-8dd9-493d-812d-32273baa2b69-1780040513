...
- [ ] Update managerService types
- [ ] Add recurring rest days UI to manager dialog
- [ ] Update rota generator to check recurring rest days
- [ ] Display recurring rest days in manager list
