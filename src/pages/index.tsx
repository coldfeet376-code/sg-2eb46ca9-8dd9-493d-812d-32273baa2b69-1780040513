...
export default function IndexPage() {
  ...
  const [staffStatusDialog, setStaffStatusDialog] = useState<{
    open: boolean;
    staffId: string;
    staffName: string;
    date: string;
  ...
  const handleOpenSmartAssign = (task: Task, date: string) => {
                ...
                <tbody>
                  {TASKS.map((task) => (
                    <RotaTableRow
                      ...
                      onStaffClick={(staffId, staffName, date, currentTask) => {
                        setStaffStatusDialog({
                          open: true,
                          staffId,
                          staffName,
                          date,
